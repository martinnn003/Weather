...
export const I18N = {
  en: {
    ...
    earlierHours: "Earlier hours",
    laterHours: "Later hours",
    today: "Today",
    tomorrow: "Tomorrow",
    ...
    linkFailed: "That city could not be found. Showing the home page instead.",
  ...
  bg: {
    ...
    earlierHours: "По-ранни часове",
    laterHours: "По-късни часове",
    today: "Днес",
    tomorrow: "Утре",
    ...
    linkFailed: "Този град не беше намерен. Показваме началната страница.",
